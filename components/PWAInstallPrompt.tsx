...
export function PWAInstallPrompt() {
    ...
    return (
      <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-50">
        <div className="flex items-start justify-between mb-2">
          <h3 className="font-semibold text-gray-900">Install Jaayvee Influencers</h3>
          <button
        ...
        <p className="text-sm text-gray-600 mb-3">
          Install Jaayvee Influencers on your iOS device for a better experience:
        </p>
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-50">
      ...
      <p className="text-sm text-gray-600 mb-3">
        Install Jaayvee Influencers app on your device for quick access and a better experience.
      </p>
